...
🚧 **Em desenvolvimento.** O README de entrega — passo a passo de inicialização, credenciais
de teste e decisões de produto — é escrito ao final da construção.

Enquanto isso, a documentação do projeto está em [`docs/`](docs/):
